...
set_property -dict { PACKAGE_PIN N11 IOSTANDARD LVCMOS33 PULLUP true } [get_ports { Reset }]; #N7 Sch=SW1 shared with SW1 Button
#set_property -dict { PACKAGE_PIN M11 IOSTANDARD LVCMOS33 PULLUP true DRIVE 4 } [get_ports { pins[36] }]; #N8 
set_property -dict { PACKAGE_PIN M10 IOSTANDARD LVCMOS33 PULLUP true DRIVE 4 } [get_ports { Led_out[1] }]; #N9 Sch=L2 shared with L2 LED
set_property -dict { PACKAGE_PIN M12 IOSTANDARD LVCMOS33 PULLUP true DRIVE 4 } [get_ports { Led_out[0] }]; #N10 Sch=L1 shared with L1 LED
#
#
### Pmod Header 'A' 
